  ...
  return (
    <StyledWrapper>
      <div className="tooltip-container">
        <span className="tooltip">How Can I Help You</span>
        <span className="text">Jharkhand Journey</span>
        {/* Center icon inside the circular button */}
        <span className="icon" aria-hidden="true">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  <path d="M20 12c0 4.418-4.03 8-9 8a9.863 9.863 0 0 1-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s8 3.582 8 8Z" 
        stroke="currentColor" 
        strokeWidth="2"
        strokeLinecap="round" 
        ...
        <svg id="Calque_1" viewBox="0 0 377 270" xmlns="http://www.w3.org/2000/svg">
          <g id="phone">
            <g id="caractere_x5F_1">
              <g>
                <path id="right_x5F_hair" className="st1" d="M199,87.1c-0.9-2.6-1.2-5.3-1.2-8.2c0.2,0.4,0.3,0.8,0.5,1.1c1.4,3.1,2.9,5.8,4.4,8
                ...
                <g id="neck_2_">
                  <path id="neck_x5F_and_x5F_shoulder" className="st2" d="M175.4,146.4c-12.7,2.3-56.5-13-69.2-11c-1.1-8.3,6.2-16.7,9.8-19.2
                  ...
                  <path id="shadow_x5F_head" className="st3" d="M166.8,104.9c-10.9,1.5-20.9-4.5-23.9-14.5c-0.7-16.2-1.2-20.4-1.2-20.4l26.2,17.5
      					C167.8,87.6,163,94.6,166.8,104.9z" />
                </g>
                <g id="face">
                  <path id="face_4_" className="st2" d="M188.2,78c-0.5,4.5-2.8,7.9-4,9.8c-1.1,1.7-1,1.1-5.4,6.3c-3.8,4.5-4,5-5.2,5.5
                  ...
                  <g>
                    <g id="nose">
                      <path className="st4" d="M176.7,63.3c0.9,1.9,1.6,3.8,2.4,5.5c0.4,0.9,0.9,1.8,1.3,2.5c0.5,0.8,1.1,1.5,1.8,1.8l1.3,0.6l-1.2,0.6
                    ...
                    <g id="left_x5F_eyebrow">
                      <path className="st5" d="M153.1,55.8c0.3-0.7,0.8-1.4,1.3-2s1.1-1.1,1.8-1.6c1.3-0.9,3-1.5,4.7-1.6c1.8-0.1,3.6,0.5,4.9,1.5
                    ...
                    <g id="right_x5F_eyebrow">
                      <path className="st5" d="M188.6,55.7c-1.2-0.8-2.2-1.3-3.1-1.5c-0.9-0.2-1.6-0.1-2.6,0h-0.3l-0.4,0.1l-0.7,0.2
                  ...
                  <path id="mouth" className="st5" d="M159.1,79.6c0,0,0.3,3.2,2.5,5.8c0.3,0.4,0.7,0.8,1.1,1.1c1.9,1.6,4.7,2.7,9.1,2.1
                  ...
                  <path id="tongue" className="st6" d="M162.7,86.5c1.9,1.6,4.7,2.7,9.1,2.1c0.5-0.1,0.9-0.2,1.3-0.4c-0.3-1.5-2.9-2.7-6-2.7
      					C165.3,85.5,163.8,85.9,162.7,86.5z" />
                  <path id="thoot" className="st7" d="M161.6,80.6c0,0.7,0.4,1.6,1.7,1.9c2.5,0.5,8.6,1.4,12.4,0.4c0,0,0.5-0.4,0.7-1.2
      					C173.6,82.3,167.8,82.9,161.6,80.6z" />
                  <path id="eye_x5F_right" className="st5" d="M186,63.8c-1.2-0.5-2.1-0.9-3.2-0.9c-1-0.1-2.1,0.1-3.3,0.4c0.3-0.6,0.9-1,1.4-1.3
      					c0.6-0.3,1.3-0.4,2-0.3C184.2,61.7,185.5,62.5,186,63.8z" />
                  <path id="eye_x5F_left" className="st5" d="M158.4,62.6c1-1.4,2.9-2.3,4.7-2.1c0.9,0.1,1.8,0.3,2.6,0.8s1.4,1.1,1.9,1.9
      					c-0.8-0.4-1.5-0.8-2.3-1c-0.8-0.3-1.5-0.4-2.3-0.5s-1.5,0-2.3,0.2C160,62,159.2,62.3,158.4,62.6z" />
                </g>
                <path id="hair_x5F_left" className="st5" d="M171.3,32.2c0.1-1.7-0.1-3.7-1.1-5.7c-4.5-8.2-21.3-6.8-29.6-5.2
                ...
                <ellipse id="left_x5F_cheek_2_" transform="matrix(8.249854e-02 -0.9966 0.9966 8.249854e-02 79.3047 221.9763)" className="st8" cx="160.2" cy="67.9" rx="1.3" ry="3.7" />
                <path id="right_x5F_cheeck" className="st8" d="M187.3,69.9L187.3,69.9c-0.6,0.1-1.3,0.2-2.1,0.1c-1.6-0.1-2.9-0.7-2.9-1.3
      				c0.1-0.6,1.4-0.9,3.1-0.8c0.6,0.1,1.2,0.2,1.7,0.3C187.1,68.8,187.2,69.3,187.3,69.9z" />
              </g>
              <g id="left_x5F_arm_2_">
                <path className="st3" d="M253.8,129.2c1.8-0.9,3.4-0.4,3.9,0.4c0.4,0.6-0.8,0.8-2.2,2.4c-1.4,1.7-3.4,5.2-3.4,5.2l-2.1-3.8
      				C249.9,133.4,251.6,130.3,253.8,129.2z" />
                <path className="st2" d="M252.4,140.8c-0.4,5.4-0.7,9.3-1.9,13.4c-0.2,0.7-0.8,2.7-1.6,5.1c-0.1,0.3-0.2,0.7-0.3,1
                ...
                <path className="st3" d="M237.8,136c0.5,0.1,1.3,2.5,2.2,2.3c0.2-0.1,1.3-0.5,1.3-0.8c0,0-0.9-1.2-1.6-1.7c-0.7-0.5-1.4-1.2-2.1-1.4
                ...
                <path className="st3" d="M243.3,135c0.4,0-1.6-2.7-1.9-3c-0.6-0.7-1.3-1.7-2.1-2.2c-0.9-0.5-2-0.2-2.5,0.7c-0.3,0.7-0.5,1.6-0.2,2.4
      				c0.6-1.1,1.2-1.6,2.4-1C240.4,132.5,243.3,135,243.3,135z" />
                <path className="st3" d="M244.9,127.7c-0.4-1.1-0.8-1.4-1.3-2.4c-0.2-0.4-0.4-0.9-0.9-0.9c-0.4,0-1.3,0.4-1.7,0.6
                ...
                <g>
                  ...
                  <path className="st3" d="M240.9,151.1c-0.2-0.6-1.9-7.6-0.1-12.6c0.1-0.4,0.5-1.1,0.5-1.1c-3.4,0.5-3,4.1-3,5.6
      					c0.1,2.2,0.6,5.5,1.5,7.6c0.3,0.7,1.2,2.2,2,2.1C241.4,152.4,241.1,151.6,240.9,151.1z" />
                </g>
                <path id="right_x5F_arm_4_" className="st2" d="M248.9,159.3c-0.1,0.7-0.3,1.5-0.6,2.2c0,0-0.2,0.6-0.6,1.5c-0.1,0.1-0.1,0.3-0.1,0.3
                ...
                <path id="shadow_x5F_right_x5F_arm_2_" className="st3" d="M221.3,176.7l-3.3,2.8c0,0-1.1-16.2-2.6-20.4L221.3,176.7z" />
              </g>
              <path id="skirt_2_" className="st10" d="M211.4,267.9H96.7c0.7-2.3,1.5-4.5,2.3-6.4c6.2-15.6,14.1-23.9,23.3-47.3
              ...
              <path id="back_x5F_left_x5F_arm_2_" className="st3" d="M111.4,188.1c3.9-2.5,6.7-13.2,10.4-37.9c1.2-8,1.7-11.5,1-16.5
              ...
              <g id="chest_1_">
                <g id="chest_4_">
                  <g>
                    <path className="st11" d="M99.9,140.4c0-1.8,0.2-12.4,8.6-20.2c7.2-6.6,17.7-8.7,27.4-5.6c3.9,7.3,7.6,9.3,10.4,9.7
                ...
                <g id="shadow_x5F_chest_2_" className="st12">
                  <g>
                    <path className="st13" d="M141.3,169.8c9.2,4,19.3,6.2,29.2,7.7c8.2,1.2,16.8,2.5,25.1,1.7c-2.2,6.8-4.5,11.3-4.5,11.3
              ...
              <g id="right_x5F_arm_1_">
                <path className="st2" d="M111.6,147.8c1.3,8.4,2.2,8.5,3.4,18c0.8,6.5,0.2,10.7-1.2,15.1c-0.9,2.9-1.2,6-4.9,8
                ...
                <path className="st3" d="M114.5,93.9c0.7-2.5,2.1-4.4,2.7-6.9c0-0.2,0.1-0.8,0.6-1.2c1.2-0.9,3.9-1.2,6.7-2.7
                ...
                <path className="st2" d="M126.2,96.5c0.3,0,0.8-0.1,1.4,0c0.6,0.1,1,0.4,1.9,0.8c2.1,1.2,1.9,0.9,2.3,1.2c1,0.8,0.8,1.2,1.9,2.1
            ...
            <g id="white-shirt">
              <path id="shirt" className="st7" d="M191,190.5c-5.2,1-11.1,1.8-17.6,2.2c-0.7-9.1-1.3-18.1-2-27.2v-18.8l1.1-19.1l-4-8
              ...
              <path id="left_x5F_shadow" className="st14" d="M135.7,107.1l4.3,6.8l3.7-0.4l-0.2-0.6c0,0,0.7-1.3,1.4-2.9c0.6-1.1,0.7-4.2,0.8-5.9
      			L135.7,107.1z" />
              <path id="shadow_x5F_right" className="st14" d="M179,104.9l-12.9-2.1c0,0,1.2,5.4,3.9,7.3c2,1.4,2.9,1.4,2.9,1.4L179,104.9z" />
              <path id="right_x5F_collar" className="st7" d="M184.8,109.7c-1.9-1.6-3.9-3.2-5.8-4.8c-4.4,4.8-8.8,9.5-13.1,14.2l-1.9,9.5l4.5-4.5
      			l4.2,7.9C176.7,124.6,180.8,117.1,184.8,109.7z" />
              <path id="left_x5F_collar" className="st7" d="M135.6,107l-6.1,4.2l17.8,20.8c1.2-3,2.5-6,3.8-8.9c2.2,2,4.5,3.9,6.7,5.9
      			c-2.1-3.4-4.2-6.8-6.3-10.1C146.2,114.9,140.9,111,135.6,107z" />
              <path id="front_x5F_left_x5F_collar" className="st14" d="M147.4,132c1.4-4.4,2.8-8.8,4.1-13.1c2,2.2,4.1,4.5,6.1,6.7
      			c-1.6-0.8-3.2-1.6-4.8-2.4c-0.6,0.8-1.2,1.7-1.9,2.6C149.5,128,148.3,130.1,147.4,132z" />
              <path id="front_x5F_right_x5F_collar" className="st14" d="M172.7,132c-2.3-4.3-4.6-8.5-6.9-12.8c-1.6,2.1-3.1,4.3-4.7,6.4
      			c1.5-0.6,2.9-1.3,4.4-2c1,0.7,2.1,1.6,3.1,2.8C170.5,128.5,171.8,130.4,172.7,132z" />
            </g>
            <g id="headphone_2_">
              <path className="st7" d="M158.6,21.9c5.4-0.1,8.1,1.2,9.2,1.9l0,0l-0.1-0.1c-0.5-0.5-3.6-3.1-10.5-3.1c-16.4-0.2-28.7,13-30.1,30.8
...
const StyledWrapper = styled.div`
  ...
  .tooltip-container {
    ...
    --outline-border-color: #047857; /* emerald-700 */
    position: relative;
    width: 64px;
    height: 64px;
  ...
  /* Hide inline text label inside the circle; tooltip will show the label */
  .text {
    position: absolute;
    width: 1px;
    height: 1px;
...
.tooltip::before {
  ...
  border-top: 10px solid var(--outline-border-color);
  z-index: -1;
}
