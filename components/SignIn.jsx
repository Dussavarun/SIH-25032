...
export default function SignInModal({ isOpen, onClose, onSwitchToSignUp }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl w-full max-w-md transform animate-slide-up border border-neutral-200/60 dark:border-neutral-800">
        {/* Modal Header */}
        ...
        <div className="p-6">
          <p className="text-neutral-600 dark:text-neutral-400 mb-6">
            Sign in to your Jharkhand Journeys account
          </p>
